...
@Component({
  ...
  templateUrl: './blogosphere.component.html',
  styleUrls: ['./blogosphere.component.scss']
})
export class BlogosphereComponent implements OnInit , AfterViewInit {
    ...
    @Input('blogosphere_results') blogosphere_results;
    get_results;
     resultsArray;
    ...
    setPage(page: number) {
        ...
        this.http.post(Config.api+'/blog/dd/' + this.params_query + '/?page=' + page + '', {
        }).subscribe(res => {
            this.main_checkbox = false;
            this.blogs = res.json();
            this.loaded = true;
