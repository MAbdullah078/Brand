...
export class BlogosphereSearchComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit() {
        ...
        this.currentList= JSON.parse(localStorage.getItem('selected_list_dd') );
        // if(this.currentList.listpage === true){
        //     this.inCurrentpage=true
        // }
        ...
        this.http.get(Config.api + '/blog/dd_categories/', {headers: headers}, 'full')
            .subscribe(res => {
    ...
    setPageDefault(page: number) {
        ...
        this.http.get(Config.api+'/blog/get_blogsphere_pages_list' )
            .subscribe(res => {
                ...
                this.pager = this.pagerService.getPager(this.d_blogs['totalItems'], page,10);
                this.loaded = true;
    ...
    setPage(page: number) {
        ...
        this.http.post(Config.api+'/blog/dd/' + this.selected_category + '/?page=' + page + '', {
            ...
            seoData:this.seo,
                ...
                this.main_checkbox = false;
                this.blogs = res.json();
                console.log('Total Items are.......',this.blogs['totalitems']);
                this.loaded = true;
