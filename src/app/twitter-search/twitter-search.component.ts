...
export class TwitterSearchComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.route.queryParams.subscribe(data=>{
            ...
            if(this.qparamschecker==='twitter'){
        ...
        this.http.get(Config.api + '/ml/twitter_categories', {headers: headers}, 'full')
            .subscribe(res => {
    ...
    get_default_Twitter_influencers(page: number) {
        if (page < 1 || page > this.pager.totalPages) {
            ...
            // this.http.get(Config.api + '/ml/get_twitter_influencers_list/' +  '?page=' + page )
                ...
                .subscribe(res => {
                    ...
                    this.pdfArray= this.influencers_by_defalut['results'];
                    this.pager = this.pagerService.getPager(this.influencers_by_defalut['totalItems'], page, 10);
    ...
    setPage(page: number, doornot: boolean = false) {
        ...
        if (this.locEm) {
            ...
            this.loaded = false;
            headers.append('Content-Type', 'application/json');
            this.http.get(Config.api + '/ml/get_twitter_users_locem/' + this.selected_category + '/' + this.locEm + '/?page=' + page + '', {headers: headers}, 'full')
                .subscribe(res => {
                    this.main_checkbox = false;
        ...
        // else if (!this.locEm) {
            ...
            this.http.post(Config.api+'/ml/get_twitter_users/' + this.selected_category + '/?page=' + page + '', {
    ...
    goTwitterProfile_by_default(influencer) {
    ...
    cheakalldef(e) {
        for (let i of this.influencers_by_defalut['results']) {
            this.inflist[i['id']] = e;
        }
        console.clear();
