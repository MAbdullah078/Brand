...
module.exports = ".example-full-width input{width:100%;border-radius:5px}.mat-form-field-placeholder-wrapper{margin:1% !important;font-size:23px !important}.influencer-hading{padding:30px 20px 2px 20px;font-size:18px;text-align:center}.popup-close-button{width:50px;height:50px;border-radius:38px;background:#000000;position:absolute;top:-20px;right:-10px;cursor:pointer;transition:all .1s ease-in-out;color:#fff;font-size:26px;font-family:\"Open Sans\", sans-serif;font-weight:500;text-align:center;line-height:50px;z-index:1}.card-header{width:82%;height:50px;border-radius:5px;background:#000000;position:absolute;top:-25px;right:70px;padding:1px;cursor:pointer;transition:all .1s ease-in-out;color:#fff;font-size:26px;font-family:\"Open Sans\", sans-serif;font-weight:500;text-align:center;line-height:50px;z-index:1}.modal-content{width:115% !important}[placeholder],input[placeholder]{color:#0A0A0A !important}mat-tab-group{box-shadow:0 3px 5px 0 rgba(0,0,0,0.5),0 6px 20px 0 rgba(0,0,0,0.19) !important;border-radius:8px;padding:8px;color:#000}section{box-shadow:0 3px 5px 0 rgba(0,0,0,0.5),0 6px 20px 0 rgba(0,0,0,0.19) !important}.body{background-color:#f9f9f9 !important}mat-form-field{width:75%}.select category{padding:4px}.btn-rounded{background:#000;color:#fff;text-align:center;margin-top:3%;border-color:black;font-size:17px;box-shadow:0 3px 5px 0 rgba(0,0,0,0.5),0 6px 20px 0 rgba(0,0,0,0.19) !important}.list-row{margin-left:15px;border-radius:3px;height:45px}.profile-container{width:100%;flex-direction:column;position:relative;border-radius:5px;background-color:#fff;box-shadow:0 3px 5px 0 rgba(0,0,0,0.5),0 6px 20px 0 rgba(0,0,0,0.19) !important;max-width:1200px;display:inline-block;margin-top:18px}.loaded-container{width:100%;flex-direction:column;position:relative;border-radius:5px;background-color:#fff;box-shadow:0 3px 5px 0 rgba(0,0,0,0.5),0 6px 20px 0 rgba(0,0,0,0.19) !important;max-width:1200px;margin-top:18px}.profile-checkbox{display:flex;flex:0 0 auto;width:65px;padding-right:12px;border-right:1px solid #ebecf3;justify-content:center;align-items:center;border-top-left-radius:5px;border-bottom-left-radius:5px;cursor:pointer}input[type=checkbox]{zoom:1.5}.tbl-cell{font-weight:600;font-size:16px;margin:8px;font-family:'Open Sans', sans-serif}.fa-map-marker-alt{margin-top:10px;font-size:15px;color:#a5a2a2}.fa-phone-alt{color:#4682b4;margin:3px}.fa-chart-bar{color:#c00}.fa-barcode{color:#4cdc6b;margin:3px}.fa-sliders-h{color:#ff6347;margin:3px}i{color:#000}.item-content{color:#6a6794;font-size:23px;font-weight:700 !important;font-family:'Merriweather', serif}.title-name{display:flex}.twitter-image{width:60px;height:60px;border-radius:50%}.followers-division{display:flex;flex-direction:column;justify-content:center}.add-to-list:hover{color:#fff}.select-all{background:#1da5de !important;border:none;box-shadow:none}.item-loc{color:#919fa9;font-size:11px;margin:3px;font-weight:600}.fa-facebook{margin-top:12px;color:#36569b;font-size:23px}.title-name img{width:40px}.fa-globe{font-size:16px;color:#1691ef}hr{margin:0 !important}.list-item1{margin-left:8px;color:#0a6aa1;font-weight:700;font-size:12px}.right-item{color:#919fa9;font-size:14px;margin-left:5px}.btn-success{background:black;border-radius:50px;border-color:black;padding:8px 26px;margin-top:3px;box-shadow:0 14px 26px -12px rgba(0,0,0,0.42),0 4px 23px 0 rgba(0,0,0,0.12),0 8px 10px -5px rgba(0,0,0,0.2) !important}.mat-tab-label-container{background-color:black;color:white}.close{margin-top:-20px !important}.temp{font-weight:bolder}\n"
