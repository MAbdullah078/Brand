...
module.exports = ".flexy{display:flex;align-items:center;justify-content:center;height:100%;background:url('LoginInflu.png') center/100% no-repeat;padding:68px 0}.forgot-pass{font-size:12px;font-weight:600;display:inline-block;color:#304ffe}.flexy ul{list-style:none;padding:0;margin-bottom:15px;display:flex;align-items:center;justify-content:center}.flexy ul li a img{transition:all .4s ease-in-out}.flexy ul li a img:hover{-webkit-transform:scale(1.2);transform:scale(1.2)}.form-content{width:500px;background:url('backkk.png');padding:10px 20px 20px;opacity:1.0;border-radius:20px}.fa-eye,.fa-eye-slash,.fa-close{position:absolute;right:0;top:6px;font-size:20px;cursor:pointer}.forgot,.privacy{font-size:12px;color:#304ffe;font-weight:600;display:inline-block}.forgot,.privacy a{color:#304ffe}.signup-label{margin:8px;font-size:16px;display:block;font-weight:600}.signup-label a{color:#304ffe}\n"
